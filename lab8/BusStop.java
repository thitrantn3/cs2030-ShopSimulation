...
class BusStop {
  ...
  public CompletableFuture<Set<BusService>> getBusServices() {
    ...
    return BusAPI.getBusServicesAt(stopId).thenApply(this::returnBusServices);
  }

  private Set<BusService> returnBusServices (String busServicesList) {
    Scanner sc = new Scanner(busServicesList);
