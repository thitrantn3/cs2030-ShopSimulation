...
class ServiceBegin extends Event{
     ...
     */
    public ServiceBegin(double time, Customer customer, int counterId, Shop shop) {
      super(time);
    ...
    public Event[] simulate() {
      ...
      shop.setCounterAvailable(false,counterId);
      double endTime = this.getTime() + this.customer.getServiceTime();
      return new Event[]{
        new ServiceEnd(endTime, this.customer, this.counterId, shop)
      };
    }
}
