...
/**
 * Test 1 for CS2030 Lab 5 (AY20/21 Special Term 1).  
 * Tests for basic Lazy property: evaluation is delayed and is 
 * done at most once.
 *
...
class Test1 {
  ...
  public static void main(String[] args) {
    ...
    i.expectCompile("Lazy<Integer> eight = Lazy.of(8) type checks",
        "cs2030.fp.Lazy<Integer> eight = cs2030.fp.Lazy.of(8)", true);
    ...
    i.expectCompile("Lazy<String> hello = Lazy.of(() -> \"hello\") type checks",
        "cs2030.fp.Producer<String> p = () -> \"hello\";" + 
        "cs2030.fp.Lazy<String> hello = cs2030.fp.Lazy.of(p);", 
        true);
