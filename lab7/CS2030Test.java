...
/**
 * A helper class to test CS2030 labs.
 */
class CS2030Test {
   ...
   * @return this object.
   */
  public CS2030Test expect(String test, Object output, Object expect) {
   ...
   * @return this object.
   */
  public <T> CS2030Test expect(String test, Supplier<T> task, Object expect) {
    System.out.print(test);
    try {
      T output = task.get();
      if ((expect == null && output == null) || output.equals(expect)) {
   ...
   * @return this object.
   */
  public <T> CS2030Test expectReturn(String test, Supplier<T> task, Object expect) {
   ...
   * @return this object.
   */
  public CS2030Test expectException(String test, Runnable task, Exception expectedE) {
   ...
   * @return this object.
   */
  public CS2030Test expectCompile(String test, String statement, boolean success) {
    System.out.print(test);
